...
public class manageEnterpriseJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnUpdate);
        btnUpdate.setBounds(290, 530, 150, 38);
        ...
        add(btnDelete);
        btnDelete.setBounds(680, 560, 110, 41);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(680, 240, 500, 310);
        ...
        add(btnAdd);
        btnAdd.setBounds(130, 530, 140, 38);
        ...
        txtEnterpriseName.setBounds(340, 410, 172, 28);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel1.setText("ENTERPRISE TYPE");
        add(jLabel1);
        jLabel1.setBounds(170, 360, 184, 22);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("NETWORK");
        add(jLabel2);
        jLabel2.setBounds(230, 310, 102, 22);
        ...
        add(cmbNetwork1);
        cmbNetwork1.setBounds(340, 310, 180, 28);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("ENTERPRISE NAME");
        add(jLabel3);
        jLabel3.setBounds(160, 410, 174, 29);
        ...
        add(cmbEntp);
        cmbEntp.setBounds(340, 360, 180, 28);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("CONTACT");
        add(jLabel6);
        jLabel6.setBounds(240, 470, 166, 22);

        txtPhoneNo.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        add(txtPhoneNo);
        txtPhoneNo.setBounds(340, 470, 172, 28);
        ...
        add(cmbNetwork);
        cmbNetwork.setBounds(840, 190, 168, 30);

        jLabel7.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        jLabel7.setText("SELECT A NETWORK");
        add(jLabel7);
        jLabel7.setBounds(670, 190, 150, 27);
        ...
        add(btnView);
        btnView.setBounds(1040, 190, 72, 28);
        ...
        lblsysadmin.setBounds(329, 40, 430, 44);
