...
public class manageManagersJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnDelete);
        btnDelete.setBounds(630, 510, 110, 39);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(630, 240, 610, 250);
        ...
        add(btnAdd);
        btnAdd.setBounds(130, 560, 121, 40);
        ...
        add(txtManagerName);
        txtManagerName.setBounds(260, 380, 194, 30);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel1.setText("ENTERPRISE");
        add(jLabel1);
        jLabel1.setBounds(120, 280, 161, 30);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("NETWORK");
        add(jLabel2);
        jLabel2.setBounds(140, 230, 102, 30);
        ...
        add(btnUpdate);
        btnUpdate.setBounds(280, 560, 110, 40);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("MANAGER NAME");
        add(jLabel3);
        jLabel3.setBounds(90, 380, 151, 30);

        txtUsername.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(txtUsername);
        txtUsername.setBounds(260, 430, 194, 30);

        jLabel4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel4.setText("USERNAME");
        add(jLabel4);
        jLabel4.setBounds(130, 430, 102, 30);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("PASSWORD");
        add(jLabel5);
        jLabel5.setBounds(130, 480, 130, 30);
        ...
        cmbEnterpriseType.setBounds(260, 280, 194, 30);

        jLabel7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel7.setText("ENTERPRISE NAME");
        add(jLabel7);
        jLabel7.setBounds(60, 330, 173, 30);
        ...
        cmbEnterpriseName.setBounds(260, 330, 194, 30);
        ...
        lblsysadmin.setBounds(265, 40, 640, 44);
