...
public class bookRoomServ extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnBookRoom);
        btnBookRoom.setBounds(390, 660, 151, 45);
        add(txtPeopleField);
        txtPeopleField.setBounds(300, 350, 342, 23);
        add(txtNumberOfRoom);
        txtNumberOfRoom.setBounds(300, 470, 334, 23);
        add(checkin);
        checkin.setBounds(300, 150, 171, 23);
        ...
        add(cmbHotel);
        cmbHotel.setBounds(300, 270, 346, 21);
        add(checkout);
        checkout.setBounds(500, 150, 153, 23);
        ...
        add(cmbCity);
        cmbCity.setBounds(300, 210, 346, 23);

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel1.setText("ROOM TYPE ");
        add(jLabel1);
        jLabel1.setBounds(30, 400, 120, 22);
        ...
        add(cmbRoomTypes);
        cmbRoomTypes.setBounds(300, 410, 334, 23);
        ...
        lblbookservices.setBounds(310, 30, 550, 44);
