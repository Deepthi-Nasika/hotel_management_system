...
public class restuarantServicePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(cmbMenu);
        cmbMenu.setBounds(980, 420, 210, 23);
        ...
        add(jLabel2);
        jLabel2.setBounds(640, 420, 250, 22);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("SELECT A RESTAURANT NAME ");
        add(jLabel4);
        jLabel4.setBounds(640, 330, 300, 22);
        ...
        add(cmbRestaurant);
        cmbRestaurant.setBounds(980, 330, 210, 23);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/mh_4.gif"))); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(100, 120, 1430, 510);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(380, 30, 603, 44);
