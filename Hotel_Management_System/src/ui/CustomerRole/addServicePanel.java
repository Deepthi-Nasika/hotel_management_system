...
public class addServicePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnEvent);
        btnEvent.setBounds(70, 220, 262, 38);
        ...
        add(btnOrder);
        btnOrder.setBounds(70, 310, 262, 42);
        ...
        add(btnHealthClub);
        btnHealthClub.setBounds(70, 400, 262, 42);
        ...
        btnOtherServices.setBounds(70, 500, 262, 38);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/mh_12.gif"))); // NOI18N
        add(jLabel2);
        jLabel2.setBounds(490, 140, 760, 550);
        ...
        jPanel2.add(jLabel1);
        jLabel1.setBounds(390, 30, 300, 40);
