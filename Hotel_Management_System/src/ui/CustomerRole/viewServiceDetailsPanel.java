...
public class viewServiceDetailsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(240, 270, 675, 480);

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel1.setText("CHECK-IN ");
        add(jLabel1);
        jLabel1.setBounds(360, 140, 100, 22);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setText("EMAIL RECEIPT TO");
        add(jLabel2);
        jLabel2.setBounds(310, 220, 160, 22);
        ...
        add(txtCheckin);
        txtCheckin.setBounds(540, 140, 249, 23);
        ...
        add(txtCheckOut);
        txtCheckOut.setBounds(540, 180, 249, 23);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(370, 30, 420, 44);
        ...
        add(btnPayment);
        btnPayment.setBounds(1040, 460, 190, 50);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("CHECK-OUT");
        add(jLabel4);
        jLabel4.setBounds(360, 180, 110, 22);

        txtEmailID.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(txtEmailID);
        txtEmailID.setBounds(540, 220, 249, 23);
