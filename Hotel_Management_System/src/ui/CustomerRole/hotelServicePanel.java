...
public class hotelServicePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnLaundry.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLaundryActionPerformed(evt);
            }
        });
        add(btnLaundry);
        btnLaundry.setBounds(200, 570, 317, 30);
        ...
        btnTransportation.setBounds(780, 570, 400, 26);
        ...
        add(jLabel3);
        jLabel3.setBounds(380, 180, 75, 22);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/mh_9.gif"))); // NOI18N
        add(jLabel2);
        jLabel2.setBounds(130, 250, 460, 290);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/mh_5.gif"))); // NOI18N
        add(jLabel4);
        jLabel4.setBounds(730, 250, 470, 290);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(390, 30, 450, 44);
        ...
        jPanel1.add(btnBack);
        btnBack.setBounds(50, 40, 100, 28);
    ...
    private void btnLaundryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLaundryActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnLaundryActionPerformed
