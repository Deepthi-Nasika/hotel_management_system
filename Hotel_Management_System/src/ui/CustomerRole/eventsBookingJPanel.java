...
public class eventsBookingJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnBack);
        btnBack.setBounds(33, 21, 100, 28);
        ...
        add(photoRadioBtn);
        photoRadioBtn.setBounds(40, 290, 200, 26);
        ...
        cateringRadioBtn.setBounds(40, 380, 108, 26);
        ...
        add(cmbCatering);
        cmbCatering.setBounds(300, 430, 445, 23);
        ...
        add(decorRadioBtn);
        decorRadioBtn.setBounds(40, 490, 210, 26);
        ...
        add(dateField);
        dateField.setBounds(300, 160, 200, 23);

        add(cmbOrg);
        cmbOrg.setBounds(300, 240, 200, 23);
