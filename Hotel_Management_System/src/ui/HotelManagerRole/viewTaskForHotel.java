...
public class viewTaskForHotel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(220, 300, 640, 260);

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel1.setText("SELECT A LAUNDARY ORG");
        add(jLabel1);
        jLabel1.setBounds(30, 210, 242, 22);
        ...
        add(cmbLaundryOrg);
        cmbLaundryOrg.setBounds(280, 210, 202, 23);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setText("SELECT A TRANSPORTATION ORG");
        add(jLabel2);
        jLabel2.setBounds(560, 210, 320, 22);

        add(cmbTransportationOrg);
        cmbTransportationOrg.setBounds(870, 210, 216, 23);
        ...
        btnAssignAndConfirmTask.setBounds(220, 610, 310, 50);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(250, 30, 660, 44);
        ...
        jPanel1.add(btnBack);
        btnBack.setBounds(50, 30, 102, 28);
