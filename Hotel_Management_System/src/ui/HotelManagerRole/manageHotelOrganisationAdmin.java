...
public class manageHotelOrganisationAdmin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnAdd);
        btnAdd.setBounds(80, 510, 110, 39);
        ...
        add(txtName);
        txtName.setBounds(210, 190, 180, 30);

        cmbOrgType.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        add(cmbOrgType);
        cmbOrgType.setBounds(210, 400, 187, 30);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel1.setText("Organisation Type");
        add(jLabel1);
        jLabel1.setBounds(30, 400, 190, 22);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("Name");
        add(jLabel6);
        jLabel6.setBounds(120, 200, 70, 22);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("Network");
        add(jLabel2);
        jLabel2.setBounds(100, 340, 102, 22);
        ...
        add(btnUpdate);
        btnUpdate.setBounds(210, 510, 96, 39);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("Organisation Name");
        add(jLabel3);
        jLabel3.setBounds(20, 450, 194, 22);

        txtUsername.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        add(txtUsername);
        txtUsername.setBounds(210, 240, 180, 30);

        txtPassword.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        add(txtPassword);
        txtPassword.setBounds(210, 290, 180, 30);

        jLabel4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel4.setText("Username");
        add(jLabel4);
        jLabel4.setBounds(90, 240, 102, 22);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("Password");
        add(jLabel5);
        jLabel5.setBounds(90, 290, 110, 22);
        ...
        add(btnBack);
        btnBack.setBounds(32, 23, 110, 28);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(450, 170, 800, 320);

        cmbOrgName.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        ...
        add(cmbOrgName);
        cmbOrgName.setBounds(210, 450, 187, 28);

        txtNetwork.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        add(txtNetwork);
        txtNetwork.setBounds(210, 340, 180, 30);
        ...
        lblsysadmin.setBounds(250, 20, 770, 44);
