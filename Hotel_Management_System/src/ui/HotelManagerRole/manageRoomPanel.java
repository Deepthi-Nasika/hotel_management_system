...
public class manageRoomPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(80, 250, 650, 390);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel1.setText("ROOM TYPE");
        add(jLabel1);
        jLabel1.setBounds(140, 180, 122, 22);

        cmbRoomType.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(cmbRoomType);
        cmbRoomType.setBounds(270, 180, 203, 23);
        ...
        add(btnBack);
        btnBack.setBounds(27, 23, 100, 28);
        ...
        add(btnAdd);
        btnAdd.setBounds(500, 180, 110, 28);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(350, 30, 360, 44);

        add(jPanel1);
        jPanel1.setBounds(0, 0, 1230, 100);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/mh_4.gif"))); // NOI18N
        jLabel4.setText("jLabel4");
        add(jLabel4);
        jLabel4.setBounds(810, 250, 300, 260);
