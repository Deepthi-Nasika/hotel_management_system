...
public class manageHotelOrganisation extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(530, 170, 600, 320);
        ...
        add(cmbOrgType);
        cmbOrgType.setBounds(250, 220, 212, 23);
        ...
        add(btnUpdate);
        btnUpdate.setBounds(200, 490, 120, 41);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("Contact");
        add(jLabel3);
        jLabel3.setBounds(140, 340, 102, 22);
        add(txtContact);
        txtContact.setBounds(250, 340, 200, 30);
        ...
        add(btnAdd);
        btnAdd.setBounds(50, 490, 114, 41);
        ...
        add(txtName);
        txtName.setBounds(250, 280, 200, 30);
        ...
        add(btnBack);
        btnBack.setBounds(25, 25, 110, 28);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Name");
        add(jLabel1);
        jLabel1.setBounds(160, 280, 70, 22);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("City");
        add(jLabel6);
        jLabel6.setBounds(170, 400, 30, 22);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Organisation Type");
        add(jLabel2);
        jLabel2.setBounds(70, 220, 200, 22);
        ...
        add(btnDelete);
        btnDelete.setBounds(530, 520, 120, 40);
        add(txtCity);
        txtCity.setBounds(250, 400, 200, 30);
        ...
        lblsysadmin.setBounds(280, 20, 710, 44);
