...
public class manageRestaurantPageJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageRestaurantJPanel
     */
    public manageRestaurantPageJPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jLabel4);
        jLabel4.setBounds(140, 370, 102, 22);
        add(txtUsername);
        txtUsername.setBounds(280, 370, 125, 23);
        add(txtPhoneNo);
        txtPhoneNo.setBounds(280, 330, 125, 23);

        btnUpdate.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnUpdate.setText("UPDATE");
        add(btnUpdate);
        btnUpdate.setBounds(363, 705, 96, 28);

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("ENTERPRISE");
        add(jLabel2);
        jLabel2.setBounds(120, 200, 145, 22);

        jLabel6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel6.setText("PHONE NUMBER");
        add(jLabel6);
        jLabel6.setBounds(90, 330, 160, 22);
        ...
        add(cmbEnterprise);
        cmbEnterprise.setBounds(280, 200, 125, 28);

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("MANAGER ID");
        add(jLabel3);
        jLabel3.setBounds(120, 290, 145, 22);
        ...
        add(btnDelete);
        btnDelete.setBounds(480, 470, 92, 28);
        add(txtManager);
        txtManager.setBounds(280, 250, 125, 23);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(480, 190, 720, 260);
        add(txtManagerID);
        txtManagerID.setBounds(280, 290, 125, 23);

        jLabel5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel5.setText("PASSWORD");
        add(jLabel5);
        jLabel5.setBounds(140, 410, 130, 22);

        btnAdd.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnAdd.setText("ADD");
        add(btnAdd);
        btnAdd.setBounds(238, 705, 90, 28);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel1.setText("MANAGER");
        add(jLabel1);
        jLabel1.setBounds(140, 250, 145, 22);
        add(txtPassword);
        txtPassword.setBounds(280, 410, 125, 23);
